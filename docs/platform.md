...
Documented callers pin a git tag. The current release is `@v1.7.0`.
...
uses: developer-experience-DevEX-platform/ci-cd-templates/.github/workflows/techdocs-publish.yml@v1.7.0
```
