...
```yaml
  deploy-staging:
    ...
    permissions:
      contents: read
    uses: developer-experience-DevEX-platform/ci-cd-templates/.github/workflows/kubernetes-gitops-cd.yml@v1.5.0
    secrets: inherit
```
...
jobs:
  promote-production:
    permissions:
      contents: read
    uses: developer-experience-DevEX-platform/ci-cd-templates/.github/workflows/kubernetes-gitops-production-promotion.yml@v1.5.0
    secrets: inherit
    with:
